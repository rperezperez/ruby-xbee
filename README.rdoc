...
== Ruby::XBee - What is it? {<img src="https://travis-ci.org/exsilium/ruby-xbee.png" />}[https://travis-ci.org/exsilium/ruby-xbee]
...
=== Determine your /dev string and configure that in config/xbeeconfig.rb (BORKEN!)
...
save the xbeeconfig.rb file. (BORKEN: There is no more xbeeconfig.rb file, currently the device is hardcoded in bin/ruby-xbee.rb)
...
To date, all testing has been done using Ruby 1.9.3 (p194). There has been extensive
